...
//         const apiKey = "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";
...
//             console.log("Complete chat history:", props.messages);
            
//             // Format the messages for better readability in console
//             const formattedMessages = props.messages.map((msg, index) => ({
...
//             } else {
//                 // Only call the API if we don't already have results showing
...
//                     <FaHistory onClick={getMessageHistory} title="Get message history" />
//                     {showSentiment && (
